    ...
    <section className="about-us">
      <div className="container">
        <div className="about-us__left">
          <h1>About us</h1>
          <p className="text">
            Argine is a digital agency that helps innovators & leaders drive
            meaningful impact on a global level using Artificial Intelligence. We
            work alongside our clients as a unified team with a shared ambition to
            redefine industries using the newest technology. Leveraging our tailored
            data centric process & army of digital innovators, we are able to
            deliver better, faster & more enduring solutions. Bold innovation
            requires the courage to change.
          </p>
          <h5>
